      ...
      <div className="bg-[#F0F0F0]  max-w-[1440px]">
        ...
        <div className="grid grid-cols-2">
          ...
          <span>
            ...
            <div className="p-16">
              <div className="rounded-2xl bg-white shadow-2xl p-8 border-2 border-black ">
                          ...
                          <CardBody className="p-4 gap-4">
                            ...
                            <div className="rounded-xl my-4 grid-cols-1">
                              ...
                              <div className="space-y-4 p-4">
                                ...
                                <div className="flex flex-row">
                                  <div className="w-full">Security Deposit</div>
                                  <div className="w-full text-end">
                                ...
                                <div className="flex flex-row">
                                  ...
                                  <div className="w-full text-end">30 days</div>
                                </div>
                              </div>
